...
export default function Register() {
  ...
  return (
    <Fragment>
      <div className="bg-[url(/avenger-bg.png)] bg-center bg-zinc-800 
        ...
        rounded-md p-[2rem] w-[384px]">
          ...
          >
            ...
            <div className="flex flex-col gap-[.375rem]">
              ...
              <div className="pwd relative flex items-end">
                ...
                pe-[.875rem] translate-y-[-120%] hover:cursor-pointer hover:opacity-[.6]`}></i>
              </div>
            ...
            py-[.875rem] font-semibold hover:opacity-[.8] cursor-pointer" type="submit">Join For Free
              Now</button>
          ...
          <div id="social" className="flex justify-between">
            <button className="flex flex-row items-center shadow-md 
            cursor-pointer gap-[12px] p-[12px] bg-white rounded-[4px] w-[8rem] justify-center">
